...
config('db_src',
       { 
         if(g_config$db$driver == 'redshift'){
           myredshift = src_postgres('mycdm', host = 'ohdsitutorialtest2-ohdsielas-redshiftclustermulti-1sizz9gq0e4uq.cc8ltappgfjt.us-east-1.redshift.amazonaws.com',
                                    port = 5439, 
                                     user = 'master', password = 'Password1')
         }
         else{
